...
async def callbacks(callback: CallbackQuery):
    ...
    try:
        ...
        if data.startswith("pay:"):
            ...
            title, description = game.invoice_text(
                uid,
                order,
            )
...
async def successful_payment(message: Message):
    ...
    # Ошибка отправки/анимации не откатывает
    # выданную награду.
    ...
    try:
        ...
        await bot.set_my_commands(
            [
                ...
                BotCommand(
                    command="paysupport",
                    description="Payment support / Поддержка",
                ),
                BotCommand(
                    command="id",
